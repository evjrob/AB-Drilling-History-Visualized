...
ggmap(ab) + geom_point(data = (wells %>% filter(`FINAL-DRILL-DATE` == ymd("1990-05-20"))), aes(x = mean_longitude, y = mean_latitude, color = "red")) + theme(legend.position="none") + ggtitle("Wells Drilled in Alberta Over Time") + geom_text(aes(label = label), data = label, vjust = "top", hjust = "left") 
```
